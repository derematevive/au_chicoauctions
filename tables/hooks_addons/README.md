...
| Name | Description |
| --- | --- |
| [`*_hook_addons`](https://github.com/derematevive/db_chico_auctions/tree/main/tables/hooks_addons/au_hook_addons.sql) | Sistema hook para addons. Intermediario numérico. |
